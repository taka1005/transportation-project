...
\caption{Blocking probability: Erlang B analytical vs.\ DES (Poisson) vs.\ DES (empirical) vs.\ observed full-capacity rate. Log $y$-axis. The $55\times$ gap at Kendall/MIT is the visual centre; MIT Vassar~St shows a qualitatively parallel gap from effectively zero predicted blocking to $2.88\%$ observed.}
\label{fig:blocking}
\end{figure}
