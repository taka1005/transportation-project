...
\paragraph{User-side risk: under-provisioning.} Bluebikes Kendall/MIT: Poisson underestimates blocking by 55-fold. A planner sizing docks or rebalancing cadence to Poisson targets would miss service failures by an order of magnitude; users find full stations and abandon trips. Bursty arrivals (CV 1.75--1.90) are where the tail events that drive blocking are averaged away.
